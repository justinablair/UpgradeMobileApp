...
describe('UpgradeTermsScreen', () => {
  ...
  it('should display specific limited company body text', () => {
  ...
  it('should display specific sole trader body text', () => {
    jest.mock('../../components/UserContext', () => {
      const originalModule = jest.requireActual('../../components/UserContext');
      return {
        __esModule: true,
    ...
    expect(findByText(/Take your time to read these documents./)).toBeTruthy();
  });
});
